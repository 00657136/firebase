...
public class MediaMainActivity extends Activity implements View.OnClickListener {

    private static final String TAG = MediaMainActivity.class.getName();
    ...
    File destDir = new File(Environment.getExternalStorageDirectory().getPath() + "/firebase/");
    ...
    void initUI() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(MediaMainActivity.this, OrientationHelper.VERTICAL,false);
        ...
        //Init Loading Dialog
        mLoadingDialog = new ProgressDialog(MediaMainActivity.this);
        mLoadingDialog.setMessage("Please wait");
        mLoadingDialog.setCanceledOnTouchOutside(false);
        mLoadingDialog.setCancelable(false);

        //Init Download Dialog
        mDownloadDialog = new ProgressDialog(MediaMainActivity.this);
    ...
    private void setResultToToast(final String result) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(MediaMainActivity.this, result, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setResultToText(final String string) {
        ...
        MediaMainActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
